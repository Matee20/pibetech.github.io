...
<body>
    ...
    $sql = "SELECT id, imagen, nombre, precio FROM productos_switch ORDER BY RAND()";
        ...
        <section class="cont">
            <?php foreach ($productos as $producto): ?>
                <div class="videojuego">
                    ...
                    <a href="../compra.php?id=<?php echo $producto['id']; ?>&categoria=switch">
                        <div class="producto">
                            <img src="<?php echo $producto['imagen']; ?>" alt="<?php echo htmlspecialchars($producto['nombre']); ?>" data-aos="fade-down">
